...
def main():
    ...
    save_path = "./results/noise_attr_tf_{}.json".format(noise_sigma)
    ...
    print("\n=== Pretraining External Model (BigTransformer) on 10k Noisy Samples ===")
    ...
    for run_idx in range(num_runs):
        ...
        # raw_set remains clean for student training.
        _, raw_set_run, _ = load_data_split(seed=run_seed, noise_sigma=0.0)
        ...
        # For distillation, we use TransformerClassifier as the student.
