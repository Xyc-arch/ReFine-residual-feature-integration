...
with open("./results/scaling.json", "r") as f:
    data = json.load(f)
...
plot_metric(x, accuracy_mean, accuracy_std,
            "Model Accuracy vs. External Model Number", "Accuracy", "accuracy.png")

plot_metric(x, auc_mean, auc_std,
            "Model AUC vs. External Model Number", "AUC", "auc.png")

plot_metric(x, f1_mean, f1_std,
            "Model F1 Score vs. External Model Number", "F1 Score", "f1.png")

plot_metric(x, inference_time_mean, inference_time_std,
            "Inference Time vs. External Model Number", "Time (s)", "inference_time.png")
