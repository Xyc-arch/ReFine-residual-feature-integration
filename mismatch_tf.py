...
from model_def100_tf import TransformerClassifier, EnhancedTransformer, BaselineAdapter100, BigTransformer
...
def main():
    ...
    save_path = "./results/mismatch_tf.json"
    num_epochs = 30
    ...
    teacher_model = BigTransformer().to(device)  # teacher outputs 100 classes
