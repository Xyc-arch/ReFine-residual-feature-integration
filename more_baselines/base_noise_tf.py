...
def main():
    ...
    # choose your flip ratios here (matches your example: [0.8, 0])
    flip_ratios = [0.8, 0.0]

    for flip_ratio in flip_ratios:
        save_path = f"./results_test10_base/noise_tf_{flip_ratio}.json"
        ...
        model_save_path = f"./model_test10/base_noise_tf_{flip_ratio}.pt"
        ...
        for run_idx in range(num_runs):
            ...
            acc, auc, f1, minc = train_lora_tf(external_model, run_loader, test_loader, device, epochs=other_epochs)
            ...
            acc, auc, f1, minc = train_dann_gate_tf(external_model, run_loader, test_loader, device, epochs=other_epochs)
